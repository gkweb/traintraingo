...
class ThemeManagementProvider extends Component {
  ...
  componentWillMount() {
    if (this.props.activeTheme && themes[this.props.activeTheme])
      this.state.updateTheme(themes[this.props.activeTheme])
  }
...
export { themes, ThemeManagementContext, ThemeManagementProvider }
